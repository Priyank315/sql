...
SELECT * 
,NTILE(4) OVER( PARTITION BY vendor_name ORDER BY sales ASC) as quartile -- In general, quartile function divides the sales into 4 quarters in ascending order.
